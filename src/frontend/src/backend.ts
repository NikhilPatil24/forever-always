...
export class Backend implements backendInterface {
    ...
    async getRSVPs(): Promise<Array<RSVPRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRSVPs();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async submitRSVP(arg0: RSVPSubmission): Promise<{
        __kind__: "ok";
        ok: string;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.submitRSVP(arg0);
